...
public class EventoPasadoController {
    ...
    public EventoPasado crear(@RequestParam("fecha") LocalDate fecha, @RequestParam("descripcion") String descripcion,@RequestParam("titulo") String titulo,@RequestParam("participantes") String participantes, @RequestParam("imagen") MultipartFile imagen){
        EventoPasado event=null;
        try {
			event=new EventoPasado(null,fecha, descripcion,titulo, participantes, ImageUtil.compressImage(imagen.getBytes()));
		} catch (IOException e) {
